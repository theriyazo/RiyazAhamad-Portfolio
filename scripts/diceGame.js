...
const init = function () {
  scores = [0, 0];
  // document.getElementById("confetti").classList.add("hide-confetti");
...
const DiceRoll = function () {
  ...
  diceEl.src = "/assets/GameAssets/diceGame/dice-" + dice + ".png";
  return dice;
};
...
btnHold.addEventListener("click", function () {
  if (playing) {
    ...
    if (scores[activePlayer] >= 100) {
      ...
      // document.getElementById("confetti").classList.remove("hide-confetti");
      document
